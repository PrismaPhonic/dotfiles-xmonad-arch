...
# Trying to set no color for color00 so terminal titlebar is translucent
color00="" # Base 00 - Black
color01="D4/46/b9" # Base 08 - Red - changed to light purple
color02="81/db/ec" # Base 0B - Green - changed to light blue
color03="dd/b2/6f" # Base 0A - Yellow
color04="6f/c2/ef" # Base 0D - Blue
color05="e1/a3/ee" # Base 0E - Magenta
color06="f7/93/7c" # Base 0C - Cyan - attempting to change to peach (first color in term?)
