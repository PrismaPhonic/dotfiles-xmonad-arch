...
myWorkspaces    = [wsTerm, wsCode, wsWorkCom, wsPersCom, wsNet, wsPrivate, wsGames, wsCircle, wsMusic]
...
myStartupHook = do
  ...
  spawnOnce "feh --bg-fill ~/wallpapers/glasstop.png"
  spawnOnce "picom -f"
